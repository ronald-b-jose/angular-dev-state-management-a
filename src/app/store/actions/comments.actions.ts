...
export const loadPostComment = createAction("[Comments Page] Load Post's comments");

export const loadPostsCommentsSuccess = createAction("[Comments Page] Load Post Comments Success",props<{ sampleComments : CommentsResponse[]}>());
